    ...
    <div>
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <jet-form-section @submitted="addTeamMember">
                ...
                <template #description>
                    Adicionar alguém ao seu baba.
                </template>

                <template #form>
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            Forneça o endereço de e-mail da pessoa que você gostaria de adicionar a esta baba.
                        </div>
                    </div>
                    ...
                    <div class="col-span-6 lg:col-span-4" v-if="availableRoles.length > 0">
                        <jet-label for="roles" value="Permissão" />
        ...
        <div v-if="team.team_invitations.length > 0 && userPermissions.canAddTeamMembers">
            ...
            <jet-action-section class="mt-10 sm:mt-0">
                ...
                <template #description>
                    Essas pessoas foram convidadas para sua equipe e receberam um e-mail de convite. Eles podem se juntar à equipe aceitando o convite por e-mail.
                </template>
